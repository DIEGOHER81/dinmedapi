...
namespace DimmedAPI.Controllers
{
    ...
    [Route("api/CancellationReasonController")]
    [ApiController]
    public class CancellationReasonsController : ControllerBase
    {
        ...
        private const string cacheTag = "CancellationReasons";


        public CancellationReasonsController(
        ...
        [HttpGet("ObtenerMotivosCancelacion")]
        [OutputCache(Tags = [cacheTag])]
        public async Task<ActionResult<IEnumerable<CancellationReasons>>> GetCancellationReason([FromQuery] string companyCode)
        {
            try
            {
                ...
                var reasons = await companyContext.CancellationReasons
                    .ToListAsync();
