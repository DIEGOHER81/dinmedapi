...
{
    public class EntryRequestFilterDTO
    {
        // Filtros opcionales
        public int? Id { get; set; }
        public DateTime? SurgeryInitFrom { get; set; }
        public DateTime? SurgeryInitTo { get; set; }
        public DateTime? SurgeryEndFrom { get; set; }
        public DateTime? SurgeryEndTo { get; set; }
